                ...
                <div class="row">
                    <div class="d-flex ">
                        <ul class="nav nav-tabs nav-sp">
                            ...
                            <li class="nav-item nav-it-sp">
                                <a class="nav-link nav-link-sp" href="{{url('')}}">DANH SÁCH SẢN
                                    PHẨM</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="mt-3" style="color:black; font-size: 20px;">Thương hiệu {{$productbrand['name']->brand_name}}</div> 
                <div class="row pt-5">
                    @foreach($productbrand['sl'] as $values)
